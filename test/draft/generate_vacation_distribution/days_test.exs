      ...
      vacation_assignments =
        GenerateVacationDistribution.Days.generate(
          ...
          %{
            ...
            total_available_minutes: 2 * 8 * 60,
            anniversary_date: ~D[2021-03-01],
            minutes_only_available_as_of_anniversary: 2 * 8 * 60
          }
        )
      ...
      vacation_assignments =
        GenerateVacationDistribution.Days.generate(
          ...
          %{
            ...
            minutes_only_available_as_of_anniversary: 1 * 8 * 60
          }
        )
      ...
      vacation_assignments =
        GenerateVacationDistribution.Days.generate(
          ...
          %{
            employee_id: employee_ranking.employee_id,
            job_class: employee_ranking.job_class,
            total_available_minutes: 1 * 8 * 60,
            anniversary_date: nil,
            minutes_only_available_as_of_anniversary: nil
          }
        )
